...
\begin{proof}
    ...
    \begin{adjustwidth}{1.5em}{}
        ...
        Take $(r,u)\in|(R,U)|$ and consider $\lp(r,u),(t,v)\rp,\lp(r,u),(t',v')\rp\in(f,g)$.
        We require that $(t,v)\coh[(T,V)](t',v')$, as $(t,v)$ is coherent to itself by equality.
        Indeed, I AM TOO TIRED AND IT'S SATURDAY NIGHT.

        We now consider the case that $(r,u)\scoh[(R,U)](r',u')$, showing that for any pairs
...
\begin{proof}
    ...
    \begin{adjustwidth}{1.5em}{}
        ...
        If we instead take $t=t'$, SOMETHING ELSE HAPPENS
...
\begin{definition}
    ...
    \begin{itemize}
        ...
        $$\dag f=\{\lp r_1r_2...r_n,t_1t_2...t_n\rp:\lp r_i,t_i\rp\in f\enspace\forall 1\le i\le n\}$$
    \end{itemize}
\end{definition}
