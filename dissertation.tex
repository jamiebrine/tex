...
\begin{definition}
    ...
    $$\bD_{R}=\{\lp(r,r_1...r_n),rr_1...r_n\rp:r_i\in|R|\}$$
\end{definition}
...
\begin{definition}
We call a rewrite rule $\vlinf{\rho}{}{T}{R}$ of $\sSys$ a \textit{(di)natural rewrite} if its model as a family of linear maps $\rho$ is a (di)natural transformation.
\end{definition}
...
\begin{align*}
f_{\sw}\comp ([g,h],k) &= \{\lp(r,t,u),(r',u',t')\rp: \\
&\quad\lp(r,t,u),(r',t',u')\rp\in([g,h],k),\lp(r',t',u'),(r',u',t')\rp\in f_{\sw}\} \\
&= \{\lp(r,t,u),(r',u',t')\rp:\lp r,r'\rp\in g, \lp t,t'\rp\in h, \lp u,u'\rp\in k\} \\
&= \{\lp(r,t,u),(r',u',t')\rp: \\
&\quad\lp(r,t,u),(r,u,t)\rp\in f_{\sw},\lp(r,u,t),(r',u',t')\rp\in[(g,k),h]\} \\
&= [(g,k),h]\comp f_{\sw}
% &= \{\lp(r',t',u'),(r',u',t')\rp:r'\in|R'|,t'\in|T'|,u'\in|U'|\} \\
% &\quad\comp\{\lp(r,t,u),(r',t',u')\rp:\lp r,r'\rp\in g, \lp t,t'\rp\in h, \lp u,u'\rp\in k\} \\
\end{align*}
\end{proof}
...
\begin{align*}
f_{\bU} &= \{\lp(r'r'_1...r'_n),(r',r'_1...r'_n):r_i\in|R|\} \\
\dag g &= \{\lp(r_1...r_n),(r'_1...r'_n)\rp:\lp r,r'\rp\in g\} \\
f_{\bU}\comp\dag g &= \{\lp()\rp:\} \\
\end{align*}
\end{proof}
...
Following the defintions, we find that the required $F$ is the trivial functor $\unit:\cohs\times\cohs^{op}\to\cohs$, which sends all coherence spaces to the trivial coherence space $*$, and all linear maps to the identity.
Then $G$ is
...
- In NELL, duplication gives copars which leads to cycles; we have it giving seqs which we conjecture does not
